      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-sm">
          ...
          {isHost && guestConnected && (
            <button onClick={() => startGame()} className="w-full py-3 rounded-lg bg-primary text-primary-foreground font-bold text-sm tracking-wide hover:opacity-90 transition-opacity mb-3">
              🏀 Start Game →
            </button>
          )}
          {isHost && !guestConnected && (
