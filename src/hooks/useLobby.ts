...
export function useLobby(): UseLobbyReturn {
  ...
  const startGame = useCallback(async () => {
    ...
    const sharedState: GameState = {
      ...
      phase: "regular",
      selectedTeamId: myTeamId,
      coachType: (data.hostCoachType ?? undefined) as any,
      coachName: data.hostCoachName ?? undefined,
      guestCoachType: (data.guestCoachType ?? undefined) as any,
      guestCoachName: data.guestCoachName ?? undefined,
    };
