...
export type CoachType = "attack" | "defense" | "playmaking";
...
export interface GameState {
  ...
  youthIntakeUsedGuest?: boolean;
  titasSamsonasRecruited?: boolean;
  coachName?: string;
  coachType?: CoachType;
  guestCoachName?: string;
  guestCoachType?: CoachType;
