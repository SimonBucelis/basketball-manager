...
export const TEAMS_DATA: Omit<Team, "players">[] = [
  ...
  { id: "sakalai",   name: 'Vilniaus "Sakalai"',       shortName: "SAK", division: "rkl", prestige: 4, color: "#1a237e", budget: 380000 },
  { id: "ringuva",   name: 'Kauno "Ringuva"',           shortName: "RIN", division: "rkl", prestige: 4, color: "#b71c1c", budget: 360000 },
  { id: "neptlcc",   name: 'Klaipėdos "Neptūnas-LCC"', shortName: "NLC", division: "rkl", prestige: 3, color: "#006064", budget: 280000 },
  { id: "nevezis",   name: 'Panevėžio "Nevėžis"',      shortName: "NEV", division: "rkl", prestige: 3, color: "#1b5e20", budget: 260000 },
  { id: "dainava",   name: 'Alytaus "Dainava"',         shortName: "DAI", division: "rkl", prestige: 2, color: "#4a148c", budget: 200000 },
  { id: "suduva",    name: 'Marijampolės "Sūduva"',    shortName: "SŪD", division: "rkl", prestige: 2, color: "#e65100", budget: 190000 },
  { id: "utenis",    name: 'Utenos "Utenis"',            shortName: "UTE", division: "rkl", prestige: 2, color: "#880e4f", budget: 185000 },
  { id: "sialugras", name: 'Šiaulių "Lukas-Grasys"',   shortName: "LGR", division: "rkl", prestige: 2, color: "#f57f17", budget: 180000 },
  // ── B Division (LKL) — 8 teams ────────────────────────────────────────────
  { id: "akvile",    name: 'BC Druskininkų "Akvilė"',  shortName: "AKV", division: "lkl", prestige: 2, color: "#00838f", budget: 130000 },
  { id: "taurage",   name: 'Tauragės "Tauragė"',        shortName: "TAU", division: "lkl", prestige: 1, color: "#558b2f", budget: 105000 },
  { id: "milasta",   name: 'BC Birštono "Milasta"',     shortName: "MIL", division: "lkl", prestige: 1, color: "#6a1b9a", budget: 100000 },
  { id: "delikat",   name: 'Joniškio "Delikatesas"',   shortName: "DEL", division: "lkl", prestige: 1, color: "#c62828", budget: 95000 },
  { id: "vetra",     name: 'Skuodo "Vėtra"',             shortName: "VĖT", division: "lkl", prestige: 1, color: "#37474f", budget: 90000 },
  { id: "zemaitija", name: 'Telšių "Žemaitija"',         shortName: "ŽEM", division: "lkl", prestige: 1, color: "#4e342e", budget: 88000 },
  { id: "zuvedra",   name: 'Molėtų "Žuvėdra"',           shortName: "ŽUV", division: "lkl", prestige: 1, color: "#0277bd", budget: 85000 },
  { id: "kaimynai",  name: 'Rokiškio "Kaimynai"',        shortName: "KAI", division: "lkl", prestige: 1, color: "#2e7d32", budget: 83000 },
];
